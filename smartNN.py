...
class SmartNN(BasicNN):
    ...
    def conduct_hpo(self, subset_size: int = 5000, n_trials: int = 10, train_subset_frac: float = 0.8):
        """
        ...
        x_train_final, y_final = x_train_final[:subset_size, :], y_final[:subset_size, :]
        gc.collect()
